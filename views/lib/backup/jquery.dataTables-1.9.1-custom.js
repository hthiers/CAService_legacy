		...
		function _fnFeatureHtmlFilter ( oSettings )
		{
			...
			sSearchStr = (sSearchStr.indexOf('_INPUT_') !== -1) ?
			  ...
			  sSearchStr==="" ? '<input type="text" />' : sSearchStr+' <input type="text" />';
                        ...
                        //sSearchStr ==="" ? '<input type="text" /> <input type="button" id="resetsearch'+oSettings.sTableId+'" class="ui-icon ui-icon-closethick" style="display: inline" />' : 
                        //sSearchStr +' <input type="text" /> <input type="button" id="resetsearch'+oSettings.sTableId+'" class="ui-icon ui-icon-closethick" style="display: inline" />';
                      
                        var sSearchStrBtn = '<span id="resetsearch'+oSettings.sTableId+'" class="ui-icon ui-icon-closethick"></span>';
			
			var nFilter = document.createElement( 'div' );
			nFilter.className = oSettings.oClasses.sFilter;
			nFilter.innerHTML = '<label>'+sSearchStr+'</label>'+sSearchStrBtn;
			...
			jqFilter
				...
				.bind( 'keypress.DT', function(e) {
					...
					if ( e.keyCode == 13 )
					{
                        ...
                        $("#resetsearch"+oSettings.sTableId, nFilter).click( function(e) {
